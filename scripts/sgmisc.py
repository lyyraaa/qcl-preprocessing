...
def preprocess_0(spectra, wavenumbers):
    ...
    spectra, wavenumbers = kit.data_deriv(spectra, wavenumbers, 41, 8, deriv)
...
def preprocess_1(spectra, wavenumbers):
    spectra = kit.all_spec_min2zero(spectra)
    spectra = kit.vector_norm(spectra)
    spectra, wavenumbers = kit.data_deriv(spectra, wavenumbers, 13, 3, deriv)
    return spectra, wavenumbers
...
def preprocess_2(spectra, wavenumbers):
    spectra = kit.all_spec_min2zero(spectra)
    spectra = kit.vector_norm(spectra)
    spectra, wavenumbers = kit.data_deriv(spectra, wavenumbers, 41, 3, deriv)
    return spectra, wavenumbers
...
def preprocess_3(spectra, wavenumbers):
    spectra = kit.all_spec_min2zero(spectra)
    spectra = kit.vector_norm(spectra)
    spectra, wavenumbers = kit.data_deriv(spectra, wavenumbers, 13, 8, deriv)
    return spectra, wavenumbers
